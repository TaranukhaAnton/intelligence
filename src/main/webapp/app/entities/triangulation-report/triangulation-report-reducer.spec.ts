...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './triangulation-report.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRIANGULATIONREPORT_LIST actions', async () => {
    ...
    it('dispatches FETCH_TRIANGULATIONREPORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TRIANGULATIONREPORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TRIANGULATIONREPORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TRIANGULATIONREPORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TRIANGULATIONREPORT actions', async () => {
      const expectedActions = [
        {
