...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './triangulation-point.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRIANGULATIONPOINT_LIST actions', async () => {
    ...
    it('dispatches FETCH_TRIANGULATIONPOINT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TRIANGULATIONPOINT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TRIANGULATIONPOINT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TRIANGULATIONPOINT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TRIANGULATIONPOINT actions', async () => {
      const expectedActions = [
        {
