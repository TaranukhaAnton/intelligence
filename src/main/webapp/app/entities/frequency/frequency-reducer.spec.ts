...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './frequency.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FREQUENCY_LIST actions', async () => {
    ...
    it('dispatches FETCH_FREQUENCY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FREQUENCY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FREQUENCY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FREQUENCY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FREQUENCY actions', async () => {
      const expectedActions = [
        {
